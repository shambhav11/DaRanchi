...
public class RecyclerActivityAdapter extends RecyclerView.Adapter<RecyclerActivityAdapter.ViewHolder>{
    ...
    public RecyclerActivityAdapter(List<RecyclerActivityModel> data, String typeData,int result, Context applicationContext,Activity activity)
    {
        this.dataToday=data;
        this.type=typeData;
        this.result=result;
    ...
    @NonNull
    @Override
    public RecyclerActivityAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(i, viewGroup, false);

        return new RecyclerActivityAdapter.ViewHolder(view);
    }
    ...
    public int getItemViewType(final int position) {
        return R.layout.recy_item_select;
    }
                ...
                public void onClick(View v) {
                    if(type.contains("Clinics"))
                    {
                        if(result!=0) {
                            ...
                            activity.setResult(120, intent1);
                            activity.finish();
                        }
                        else {
